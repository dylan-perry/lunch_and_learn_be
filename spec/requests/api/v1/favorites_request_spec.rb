    ...
    describe "Favorites Index" do
        ...
        describe "happy path" do
            ...
            it "returns an empty array when user has no favorites" do
                user2 = User.create!(name: "Frabgulajad", email: "frab@gmail.com", password: "credit_score", password_confirmation: "credit_score")
        ...
        describe "sad path" do
            it "errors out when api_key does not match existing users" do
                get "/api/v1/favorites?api_key=#{SecureRandom.hex(32)}"
